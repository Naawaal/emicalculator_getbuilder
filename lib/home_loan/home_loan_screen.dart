...
class HomeloanContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void updateEmiController() {
      ...
      final double loanTenure = double.tryParse(tenureController.text) ?? 0.0;
            ...
            children: [
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: Container(
                          ...
                          child: const Icon(Icons.percent, color: Colors.black),
                        ),
                        border: const OutlineInputBorder(
                          borderSide: BorderSide(
                            color: Colors.black,
                            ...
                            Container(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ...
                                  selectedTenure = emiController.loanTenure /
                                      12; // Convert to years
                                  updateEmiController();
                                },
                                child: const Row(
                            ...
                            Container(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ...
                                  selectedTenure = emiController
                                      .loanTenure; // Convert to months
                                  updateEmiController();
                                },
                                child: const Row(
                                  children: [
              ...
              Visibility(
                  ...
                  child: SfSlider(
                    ...
                    showTicks: true,
                    value:
                        selectedTenure, // Use selectedTenure to set the initial value
                    onChanged: (newValue) {
                          ...
                          Container(
                            child: Column(
                              children: [
                                const Text('Loan EMI'),
                                Text(
                                    'EMI Amount: ${emiController.emi.toStringAsFixed(2)}'),
                              ],
                            ),
                          ),
                          const Divider(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                    'EMI Amount: ${emiController.totalInterestPayable.toStringAsFixed(2)}'),
                              ],
                            ),
                          ),
                          const Divider(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                    'EMI Amount: ${emiController.totalPayment.toStringAsFixed(2)}'),
                              ],
                            ),
                          )
                        ],
